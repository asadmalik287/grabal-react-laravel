...
<form class="form-valide" id="update-form">
    ...
    <div class="modal-footer">
        ...
        <button type="button" class="btn btn-success" onclick="commonFunction(false,'{{ route('categories.update',$category->id) }}','{{route('categories.index')}}','post','','update-form');">Save</button>
    </div>
</form>
