...
<div><h3 class="text-center mb-3">All Categories</h3></div>

<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="text-right mb-4"><button class="btn btn-primary" data-toggle="modal" data-target="#addCategory">Add new +</button></div>
        ...
        <div class="modal-content">
            <form class="form-valide" id="create-form">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success" onclick="commonFunction(false,'{{ route('categories.store') }}','{{route('categories.index')}}','post','','create-form');">Save</button>
                </div>
            </form>
        </div>
    </div>
